...
<li class="explode" key="300" name="menu">
  PHP文章管理
  <ul>
    <li class="menu-item"><a href="1_art.php?act=list" target="main-frame">文章列表</a></li>
    <li class="menu-item"><a href="1_art.php?act=add" target="main-frame">文章添加</a></li>
  </ul>
</li>
