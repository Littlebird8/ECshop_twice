...
<table width="100%" >
  <tr>
    ...
    <td><?php if ($this->_var['form_action'] == "update"): ?><?php echo $this->_var['user']['nickname']; ?><input type="hidden" name="nickname" value="<?php echo $this->_var['user']['nickname']; ?>" /><?php else: ?><input type="text" name="nickname" maxlength="60" value="<?php echo $this->_var['user']['nickname']; ?>" /><?php echo $this->_var['lang']['require_field']; ?><?php endif; ?></td>
  </tr>
  <tr>
